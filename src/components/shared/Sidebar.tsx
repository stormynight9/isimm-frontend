                        ...
                        <div className="flex h-[calc(100%-74px)] flex-col justify-between">
                            <Menu className="max-h-screen overflow-y-auto">
                                ...
                                >
                                    <MenuItem
                                        icon={<CalendarCheckIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/notes/semester1"} />}
                                    >
                                        Semestre 1
                                    </MenuItem>
                                    <MenuItem
                                        icon={<CalendarCheckIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/notes/semester2"} />}
                                    >
                                        Semestre 2
                                    </MenuItem>
                                    <MenuItem
                                    ...
                                    <MenuItem
                                        icon={<SettingsIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/notes/reclamationEnseignant"} />}
                                    >
                                ...
                                >
                                    ...
                                    <MenuItem
                                        ...
                                        component={<Link to={"/magasin/magasinier/demande/list"} />}
                                    >
                                        Demandes
                                    </MenuItem>
                                    <MenuItem
                                        icon={<ClipboardListIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/magasin/magasinier/facture/list"} />}
                                    >
                                        Factures
                                    </MenuItem>
                                    <MenuItem
                                        icon={<BoxIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/magasin/magasinier/produit/list"} />}
                                    >
                                        Produits
                                    </MenuItem>
                                    <MenuItem
                                        ...
                                        component={
                                            <Link to={"/magasin/magasinier/fournisseur/list"} />
                                        }
                                    >
                                        Fournisseurs
                                    </MenuItem>
                                ...
                                >
                                    ...
                                    <MenuItem
                                        icon={<CalendarSearchIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/magasin/employer/demande/list"} />}
                                    >
                                        Demandes
                                    </MenuItem>
                                ...
                                >
                                    ...
                                    <MenuItem
                                        icon={<SearchIcon size={20} strokeWidth={2.4} />}
                                        component={<Link to={"/charge/rechercher-enseignant/"} />}
                                    >
