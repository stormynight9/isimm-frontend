        ...
        <div style={{ margin: "120px" }}>
            ...
            <div className="font max-w-md scroll-m-20 text-4xl">
                ...
                <select
                    ...
                    disabled
                >
                    <option defaultValue>Select Produit</option>
                ...
                <select
                    name="etat"
                    value={demandeProduit.etat}
                    onChange={(e) => handleChange(e)}
                    className="select form-select"
                >
                    <option style={{ display: "none" }}>En attente</option>
                    <option value="approuvée" name="etat">
                        Approuvée
                    </option>
                    <option value="refusé" name="etat">
                        Refusé
                    </option>
                </select>
